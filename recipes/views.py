...
def search(request):
    if request.method == "POST":
        ...
        recipes = Recipe.objects.filter(Q(name__icontains=search) | Q(ingredients__icontains=search))
        return render(request, 'recipes/search.html', {'search': search, 'recipes': recipes})
    else:
